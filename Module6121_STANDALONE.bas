...
' --- MODULE6121 (standalone: all in this one module) ---
Private Const LIMIT_JOB_SEARCH_TO_RECENT_MONTHS As Boolean = True
Private Const JOB_SEARCH_MONTHS_BACK As Long = 2
Private Const M6121_SEED_LIBRARY_FROM_RECENT_JOBS As Boolean = True
Private Const M6121_CAD_NAMING_LIBRARY_FILE As String = "CMS_Block_Naming_Library.csv"
...
' MODULE6121 library code is inlined at the bottom of this module (one file).
' ============================================================
...
On Error GoTo ErrHandler
    ...
    LogLine "Job search month window: " & M6121_AllowedMonthLabelsText()
    LogLine "========================================"
...
' (inlined; current month + JOB_SEARCH_MONTHS_BACK prior months)
' ============================================================
' ============================================================
' PUBLIC ENTRY POINTS
' ============================================================
...
On Error GoTo ErrHandler
    ...
    If LOCAL_WORKSPACE_ROOT <> "" Then
        M6121_LogLine "Scanning local workspace: " & LOCAL_WORKSPACE_ROOT
        M6121_ScanLocalWorkspaceForLibraryRows LOCAL_WORKSPACE_ROOT, existing, f, addedCount
    End If
...
On Error GoTo ErrHandler
    ...
    If LIMIT_JOB_SEARCH_TO_RECENT_MONTHS = False Then
